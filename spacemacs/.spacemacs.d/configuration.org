...
*** Project structure
    #+begin_src emacs-lisp
(fset 'orgproject
   [C-return M-right ?R ?a ?t ?i ?o ?n ?a ?l ?e C-return ?D ?e ?s ?i ?r ?e ?d ?  ?r ?e ?s ?u ?l ?t ? ?( ?D ?e ?f ?i ?n ?i ?t ?i ?o ?n ?  ?o ?f ?  ?D ?o ?n ?e ?) C-return ?R ?e ?l ?e ?v ?a ?n ?t ?  ?i ?n ?f ?o ?r ?m ?a ?t ?i ?o ?n C-return ?A ?c ?t ?i ?o ?n ?s])
    #+end_src
