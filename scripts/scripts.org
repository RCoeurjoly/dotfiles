...
** Pending classification
   #+NAME: utils-pending-classification
   #+begin_src shell :noweb yes :exports code
# -*- mode: sh -*-
...
** Architecture
   #+NAME: variables
   #+begin_src shell :noweb yes :exports code
<<variables-pending-classification>>
<<debian-packages>>
   #+end_src
** Debian packages
...
** Pending classification
   ...
   #+NAME: variables-pending-classification
   #+begin_src shell :noweb yes :exports code
